...
public final class ConnectionPool {
	...
	private static ConnectionPool cp;		//싱글톤 패턴 생성 - 생성자
	...
	public synchronized void releaseConnection(Connection _con) throws SQLException { //커넥션 반납
		boolean flag = false;
...
//사용자가 있는 경우 강제 종료
	...
	// free에 있는 커넥션을 모두 삭제해 버림. 
		...
		Connection _con = (Connection) free.get(i);free.remove(i--);
		try{
		_con.close();
	}catch(
	SQLException sqle)
